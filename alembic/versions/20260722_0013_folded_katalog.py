...
def upgrade() -> None:
    op.create_table(
        ...
        sa.CheckConstraint(
            "revision >= 1", name=op.f("ck_collection_positive_collection_revision")
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["library_root_id"],
            ["library_root.id"],
            name=op.f("fk_audit_issue_library_root_id_library_root"),
            ondelete="CASCADE",
        ),
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            ...
            name=op.f("ck_library_item_valid_episode_number"),
        ),
        sa.CheckConstraint(
            "release_year IS NULL OR release_year BETWEEN 1 AND 9999",
            name=op.f("ck_library_item_valid_release_year"),
        ),
        sa.CheckConstraint(
            "season_number IS NULL OR season_number >= 0",
            name=op.f("ck_library_item_valid_season_number"),
        ),
        sa.ForeignKeyConstraint(
            ["library_root_id"],
            ["library_root.id"],
            name=op.f("fk_library_item_library_root_id_library_root"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["parent_id"],
            ["library_item.id"],
            name=op.f("fk_library_item_parent_id_library_item"),
            ondelete="CASCADE",
        ),
    ...
    op.create_index(
        "ix_library_item_root_parent",
        "library_item",
        ["library_root_id", "parent_id"],
        unique=False,
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column(
            "cancellation_requested", sa.Boolean(), server_default=sa.text("0"), nullable=False
        ),
        ...
        sa.ForeignKeyConstraint(
            ["library_root_id"],
            ["library_root.id"],
            name=op.f("fk_maintenance_job_library_root_id_library_root"),
            ondelete="SET NULL",
        ),
    ...
    op.create_table(
        ...
        sa.Column("revision", sa.Integer(), server_default="1", nullable=False),
        sa.CheckConstraint(
            "revision >= 1", name=op.f("ck_watch_order_positive_watch_order_revision")
        ),
        sa.ForeignKeyConstraint(
            ["collection_id"],
            ["collection.id"],
            name=op.f("fk_watch_order_collection_id_collection"),
            ondelete="CASCADE",
        ),
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            "size_bytes >= 0", name=op.f("ck_cached_artwork_nonnegative_cached_artwork_size")
        ),
        sa.ForeignKeyConstraint(
            ["library_item_id"],
            ["library_item.id"],
            name=op.f("fk_cached_artwork_library_item_id_library_item"),
            ondelete="SET NULL",
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["collection_id"],
            ["collection.id"],
            name=op.f("fk_collection_membership_collection_id_collection"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["library_item_id"],
            ["library_item.id"],
            name=op.f("fk_collection_membership_library_item_id_library_item"),
            ondelete="CASCADE",
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["issue_id"],
            ["audit_issue.id"],
            name=op.f("fk_hierarchy_repair_run_issue_id_audit_issue"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["item_id"],
            ["library_item.id"],
            name=op.f("fk_hierarchy_repair_run_item_id_library_item"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["library_root_id"],
            ["library_root.id"],
            name=op.f("fk_hierarchy_repair_run_library_root_id_library_root"),
            ondelete="SET NULL",
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["library_item_id"],
            ["library_item.id"],
            name=op.f("fk_library_item_edit_event_library_item_id_library_item"),
            ondelete="CASCADE",
        ),
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            ...
            name=op.f("ck_media_file_nonnegative_duration"),
        ),
        ...
        sa.ForeignKeyConstraint(
            ["library_item_id"],
            ["library_item.id"],
            name=op.f("fk_media_file_library_item_id_library_item"),
            ondelete="CASCADE",
        ),
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            ...
            name=op.f("ck_metadata_binding_valid_confidence"),
        ),
        sa.ForeignKeyConstraint(
            ["library_item_id"],
            ["library_item.id"],
            name=op.f("fk_metadata_binding_library_item_id_library_item"),
            ondelete="CASCADE",
        ),
    ...
    op.create_index(
        "ix_metadata_binding_provider_id",
        "metadata_binding",
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            ...
            name=op.f("ck_metadata_candidate_valid_candidate_confidence"),
        ),
        sa.ForeignKeyConstraint(
            ["library_item_id"],
            ["library_item.id"],
            name=op.f("fk_metadata_candidate_library_item_id_library_item"),
            ondelete="CASCADE",
        ),
    ...
    op.create_index(
        "ix_metadata_candidate_review", "metadata_candidate", ["status", "confidence"], unique=False
    )
    op.create_table(
        "playback_session",
        ...
        sa.CheckConstraint(
            ...
            name=op.f("ck_playback_session_nonnegative_current_entry_position"),
        ),
        sa.ForeignKeyConstraint(
            ["context_item_id"],
            ["library_item.id"],
            name=op.f("fk_playback_session_context_item_id_library_item"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["user_id"],
            ["user.id"],
            name=op.f("fk_playback_session_user_id_user"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["watch_order_id"],
            ["watch_order.id"],
            name=op.f("fk_playback_session_watch_order_id_watch_order"),
            ondelete="SET NULL",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_playback_session")),
    )
    op.create_index(
        "ix_playback_session_user_expiry",
        "playback_session",
        ["user_id", "expires_at"],
        unique=False,
    )
    op.create_index(
        "ix_playback_session_watch_order", "playback_session", ["watch_order_id"], unique=False
    )
    op.create_table(
        "playback_state",
        sa.Column("id", sa.Integer(), nullable=False),
        ...
        sa.CheckConstraint(
            "duration_seconds >= 0", name=op.f("ck_playback_state_nonnegative_duration")
        ),
        sa.CheckConstraint(
            "play_count >= 0", name=op.f("ck_playback_state_nonnegative_play_count")
        ),
        sa.CheckConstraint(
            "position_seconds >= 0", name=op.f("ck_playback_state_nonnegative_position")
        ),
        sa.ForeignKeyConstraint(
            ["library_item_id"],
            ["library_item.id"],
            name=op.f("fk_playback_state_library_item_id_library_item"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["user_id"],
            ["user.id"],
            name=op.f("fk_playback_state_user_id_user"),
            ondelete="CASCADE",
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["library_item_id"],
            ["library_item.id"],
            name=op.f("fk_watch_order_entry_library_item_id_library_item"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["watch_order_id"],
            ["watch_order.id"],
            name=op.f("fk_watch_order_entry_watch_order_id_watch_order"),
            ondelete="CASCADE",
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["media_file_id"],
            ["media_file.id"],
            name=op.f("fk_media_access_token_media_file_id_media_file"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["playback_session_id"],
            ["playback_session.id"],
            name=op.f("fk_media_access_token_playback_session_id_playback_session"),
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_media_access_token")),
    )
    op.create_index(
        "ix_media_access_token_expiry", "media_access_token", ["expires_at"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["library_item_id"],
            ["library_item.id"],
            name=op.f("fk_metadata_review_event_library_item_id_library_item"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["metadata_binding_id"],
            ["metadata_binding.id"],
            name=op.f("fk_metadata_review_event_metadata_binding_id_metadata_binding"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["metadata_candidate_id"],
            ["metadata_candidate.id"],
            name=op.f("fk_metadata_review_event_metadata_candidate_id_metadata_candidate"),
            ondelete="SET NULL",
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["playback_session_id"],
            ["playback_session.id"],
            name=op.f("fk_playback_launch_token_playback_session_id_playback_session"),
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_playback_launch_token")),
    )
    op.create_index(
        "ix_playback_launch_token_expiry", "playback_launch_token", ["expires_at"], unique=False
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            "position >= 0",
            name=op.f("ck_playback_session_entry_nonnegative_session_entry_position"),
        ),
        sa.CheckConstraint(
            "source_watch_order_position IS NULL OR source_watch_order_position >= 0",
            name=op.f("ck_playback_session_entry_nonnegative_source_watch_order_position"),
        ),
        sa.ForeignKeyConstraint(
            ["library_item_id"],
            ["library_item.id"],
            name=op.f("fk_playback_session_entry_library_item_id_library_item"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["media_file_id"],
            ["media_file.id"],
            name=op.f("fk_playback_session_entry_media_file_id_media_file"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["playback_session_id"],
            ["playback_session.id"],
            name=op.f("fk_playback_session_entry_playback_session_id_playback_session"),
            ondelete="CASCADE",
        ),
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            "entry_position >= 0",
            name=op.f("ck_playback_session_event_nonnegative_event_entry_position"),
        ),
        sa.CheckConstraint(
            "position_seconds >= 0",
            name=op.f("ck_playback_session_event_nonnegative_event_position"),
        ),
        sa.ForeignKeyConstraint(
            ["playback_session_id"],
            ["playback_session.id"],
            name=op.f("fk_playback_session_event_playback_session_id_playback_session"),
            ondelete="CASCADE",
        ),
